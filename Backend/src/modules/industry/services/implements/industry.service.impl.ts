...
import { IIndustryService } from '../industry.service';

class IndustrySerivce implements IIndustryService {
...
export const industryService: IIndustryService = new IndustrySerivce();
